...
namespace Utils.Responses
{
    ...
    public class Result : IResult
    {
        ...
        protected Result(bool isSuccess, int statusCode, string? message,  IEnumerable<string>? errors = null)
        {
            IsSuccess = isSuccess;
        ...
        public static Result Failure(IEnumerable<string> errors, int statusCode = 400) => new Result(false, statusCode, null, errors);
